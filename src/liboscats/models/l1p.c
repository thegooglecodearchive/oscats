...
G_DEFINE_TYPE(OscatsIrtModelL1p, oscats_irt_model_l1p, OSCATS_TYPE_IRT_MODEL);
...
static void oscats_irt_model_l1p_class_init (OscatsIrtModelL1pClass *klass)
{
...
static void oscats_irt_model_l1p_init (OscatsIrtModelL1p *self)
{
}
...
static void model_constructed(GObject *object)
{
  ...
  G_OBJECT_CLASS(oscats_irt_model_l1p_parent_class)->constructed(object);
